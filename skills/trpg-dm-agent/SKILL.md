...
1. Start from a plot seed. If the seed is incomplete, supplement it with a central conflict, factions, 5-6 maps, wilderness/event triggers, and a first-session hook.
